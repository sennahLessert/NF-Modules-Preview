...
//#endregion
//#region src/components/Tile.ts
var $ = class extends J {
	constructor(...e) {
		super(...e), this.title = "Package Basic", this.firstButtonText = "Learn more", this.secondButtonText = "", this.headline = "", this.items = [
			"NEXT Farming App",
			"NEXT crop planning and documentation",
			"NEXT Waylineconverter",
			"Talking Fields products"
		], this.hideFooter = !1, this.isBigTile = !1;
	}
	static {
		this.styles = o`
        :host {
	...
	renderHeadline() {
		return L`<div class="headline">${this.headline}</div>`;
	}
	renderDescription() {
		return L`<div class="text" .innerHTML=${this.description || ""}></div>`;
	}
	renderNothing() {
		return L``;
	}
	...
	render() {
		return this.isBigTile && (this.hideFooter = !0), L`
...
Q([Y()], $.prototype, "title", void 0), Q([Y()], $.prototype, "tag", void 0), Q([Y()], $.prototype, "firstButtonText", void 0), Q([Y()], $.prototype, "secondButtonText", void 0), Q([Y()], $.prototype, "headline", void 0), Q([Y()], $.prototype, "description", void 0), Q([Y({ type: Array })], $.prototype, "items", void 0), Q([Y({ type: Boolean })], $.prototype, "hideFooter", void 0), Q([Y({ type: Boolean })], $.prototype, "isBigTile", void 0), Q([Y()], $.prototype, "subsection", void 0), $ = Q([_e("nf-tile")], $);
//#endregion
//#region src/MyApp.ts
	...
	getPackages() {
		return [
			...
			},
			{
				...
				items: ["NEXT Crop Planning and documentation pro", "NEXT Fertilization"],
